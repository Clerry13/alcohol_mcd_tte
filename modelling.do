...
**sub-analysis by sex
stcrreg i.cgah_new ageatsurvey edu marital nutrition bmi alchistory if sex==1, compete(evermcd==2) tvc(nearestsmk nearestinc nearestphys) texp(_t)
stcrreg i.cgah_new ageatsurvey edu marital nutrition bmi alchistory if sex==2, compete(evermcd==2) tvc(nearestsmk nearestinc nearestphys) texp(_t)
